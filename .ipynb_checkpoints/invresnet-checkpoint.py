...
class InvResNet(nn.Module):
    ...
    def __init__(self, block, layers, output_size=64, output_channels=3, input_dims=99, layer_normalization='none'):
...
def invresnet18():
    ...
    return InvResNet(InvBasicBlock, [2, 2, 2, 2],layer_normalization='batch')    